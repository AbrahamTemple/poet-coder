...
public final class ParameterizedTypeName extends com.squareup.javapoetx.TypeName {
  private final ParameterizedTypeName enclosingType;
  public final ClassName rawType;
  public final List<com.squareup.javapoetx.TypeName> typeArguments;

  ParameterizedTypeName(ParameterizedTypeName enclosingType, ClassName rawType,
      List<com.squareup.javapoetx.TypeName> typeArguments) {
  ...
  private ParameterizedTypeName(ParameterizedTypeName enclosingType, ClassName rawType,
                                List<com.squareup.javapoetx.TypeName> typeArguments, List<com.squareup.javapoetx.AnnotationSpec> annotations) {
    super(annotations);
    ...
    for (com.squareup.javapoetx.TypeName typeArgument : this.typeArguments) {
  ...
  @Override
  public com.squareup.javapoetx.TypeName withoutAnnotations() {
    return new ParameterizedTypeName(
  ...
  CodeWriter emit(CodeWriter out) throws IOException {
    ...
    if (!typeArguments.isEmpty()) {
      ...
      for (com.squareup.javapoetx.TypeName parameter : typeArguments) {
   ...
   */
  public ParameterizedTypeName nestedClass(String name, List<com.squareup.javapoetx.TypeName> typeArguments) {
    checkNotNull(name, "name == null");
  ...
  public static ParameterizedTypeName get(ClassName rawType, com.squareup.javapoetx.TypeName... typeArguments) {
  ...
  static ParameterizedTypeName get(ParameterizedType type, Map<Type, TypeVariableName> map) {
    ...
    List<com.squareup.javapoetx.TypeName> typeArguments = TypeName.list(type.getActualTypeArguments(), map);
