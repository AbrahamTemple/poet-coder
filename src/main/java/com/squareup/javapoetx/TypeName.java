 ...
 * ParameterizedTypeName}, {@link TypeVariableName}, and {@link com.squareup.javapoetx.WildcardTypeName}.
 */
public class TypeName {
  ...
  private TypeName(String keyword, List<com.squareup.javapoetx.AnnotationSpec> annotations) {
    this.keyword = keyword;
    this.annotations = Util.immutableList(annotations);
  }

  // Package-private constructor to prevent third-party subclasses.
  TypeName(List<com.squareup.javapoetx.AnnotationSpec> annotations) {
    this(null, annotations);
  }

  public final TypeName annotated(com.squareup.javapoetx.AnnotationSpec... annotations) {
    return annotated(Arrays.asList(annotations));
  }

  public TypeName annotated(List<com.squareup.javapoetx.AnnotationSpec> annotations) {
  ...
  protected final List<com.squareup.javapoetx.AnnotationSpec> concatAnnotations(List<com.squareup.javapoetx.AnnotationSpec> annotations) {
    List<com.squareup.javapoetx.AnnotationSpec> allAnnotations = new ArrayList<>(this.annotations);
  ...
  static TypeName get(TypeMirror mirror,
    ...
    return mirror.accept(new SimpleTypeVisitor8<TypeName, Void>() {
      ...
      @Override public TypeName visitWildcard(javax.lang.model.type.WildcardType t, Void p) {
        return com.squareup.javapoetx.WildcardTypeName.get(t, typeVariables);
      }
