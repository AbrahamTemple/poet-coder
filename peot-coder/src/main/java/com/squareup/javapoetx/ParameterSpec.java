...
public final class ParameterSpec {
  ...
  void emit(CodeWriter codeWriter, boolean varargs) throws IOException {
    ...
    if (varargs) {
      com.squareup.javapoetx.TypeName.asArray(type).emit(codeWriter, true);
    } else {
  ...
  public static ParameterSpec get(VariableElement element) {
    ...
    com.squareup.javapoetx.TypeName type = com.squareup.javapoetx.TypeName.get(element.asType());
  ...
  Builder toBuilder(com.squareup.javapoetx.TypeName type, String name) {
